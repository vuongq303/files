...
function migrateWarn( code, msg ) {
	...
	if ( jQuery.migrateIsPatchEnabled( code ) &&
		...
		if ( console && console.warn && !jQuery.migrateMute ) {
         ...
         // added in #4758 so we can get raygun notifications on live
         try{
            if(typeof rg4js !== 'undefined'){
                rg4js('send', {
                    error: new Error(msg), // note the stack trace is part of the Error object. raygun will pick it up automatically
                    tags: ["JQMIGRATE", "JQMIGRATE-" + jQuery.migrateVersion]
                });
            }
        }
        catch(err){}
